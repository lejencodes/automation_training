...
class LoginPage:
    ...
    def login(self, suc, username, password):
        try:
            self.driver.find_element_by_link_text(self.login_btn).click()
            ...
            if suc == '1':
                self.login_status = self.driver.find_element_by_xpath(self.login_suc).text
                return self.login_status
            if suc == '0':
                self.login_status = self.driver.find_element_by_xpath(self.login_err).text
